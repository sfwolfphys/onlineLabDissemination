...
\begin{center}
\only<1>{\includegraphics[page=1, height=3.in, valign=m]{PICUP1.pdf}}
\only<2>{\includegraphics[page=2, height=3in, valign=m]{PICUP1.pdf}}
\only<3>{\includegraphics[page=3, height=3in, valign=m]{PICUP1.pdf}}
\only<4>{\includegraphics[page=4, height=3in, valign=m]{PICUP1.pdf}}
\end{center}
\end{frame}
